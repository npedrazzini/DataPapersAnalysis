...
datasets = './curated_inputs/datasets_datapapers-links-rdj.csv'

headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36'}

with open(datasets) as incsv, open('./outputs/scraper_outputs/rdj/{}-scraper-datasets-rdj.csv'.format(todaysdate),'w') as csv_crawler:
